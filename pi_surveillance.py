...
# check to see if the Dropbox should be use
if conf["use_dropbox"]:
...
for f in camera.capture_continuous(rawCapture, format='bgr', use_video_port=True):
    ...
    # threshold the delta image, dilate the thresholded image to fill in holes, then find contours
    ...
    for c in cnts:
        ...
        text = 'Occupied'
    # draw the text and timestmap on the frame
